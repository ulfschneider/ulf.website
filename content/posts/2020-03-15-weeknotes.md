...
- Debugging CSS with <code>_ {outline: 1px solid red;}</code> is better than setting <code>_ {border: 1px solid red;}</code>, because outline doesn't affect the box model!
