...
Naming aside, designing and developing should not be a waterfall process, where a designer has to get the design right in the first pass and the developer will pick up and *simply* build what has been designed. 

At a side note, the currently popular Figma has a tendency to [push development teams into the waterfall direction](/2023-06-28-move-on-from-figma/) and for that reason I avoid Figma in web development projects. Instead, I prefer to work with the materials at hand, HTML, CSS, and JavaScript (TypeScript). It avoids handoff and allows to adhere to what really lays in the materials.
