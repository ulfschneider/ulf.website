...
With the HTML attribute [`capture`](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/capture), you can do on _mobile_ web browsers:^[On *desktop* browsers a file upload dialog will be displayed.]
...
What's not used, but would be possible, is to integrate the [`multiple`](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/multiple) attribute to capture _multiple_ media with a single dialog.
...
- The file upload dialog looks so awkward that you anyway need to style it with JavaScript, the advantage of _only HTML_ is gone in my view.
