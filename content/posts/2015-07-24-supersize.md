...
You may want to *use* agile only for a single project with 8, 20 or even 50 people and don´t think about your entire organization at first hand. That is okay, growing natural makes sense, and to understand how things work in the small and then scal, will give some chance for any scaling endeavor to function. Chances are, you try to go the agile way because your project currently is about to sink. This approach may also work because then you have some pressure for clarity and right decisions – but no guarantee that you will make the right decisions of course.
