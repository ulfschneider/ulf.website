...
When planning for the feature I visited several blogs I'm following with my RSS^[It's always a satisfying moment to find a new and interesting author having an RSS feed and getting their content with one click by leveraging the most simple and open format for following content on the web. As a bonus, you do not have to give away your e-mail address to receive the content automatically.] reader to see how commenting can be addressed. I could identifiy four _commenting categories:_
