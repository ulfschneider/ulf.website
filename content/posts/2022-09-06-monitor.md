...
`monitorEvents()` allows to observe events from the web browser console for Safari, Chrome and Edge. _Firefox doesn't support it._ Events will be logged to the console.
...
`monitor()` allows to observe function calls from the web browser console for Chrome and Edge. _Safari and Firefox do not support it._
